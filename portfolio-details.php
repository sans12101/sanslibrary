...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">Vesperr</a></h1>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Judul    :</strong>Laskar Pelangi</li>
                <li><strong>Penulis  :</strong>Andrea Hirata</li>
                <li><strong>Penerbit :</strong>Bentang Pustaka</li>
                <li><strong>Tahun-Terbit:</strong>2005-Agustus-17</li>
              </ul>
            </div>
            <div class="portfolio-description">
              ...
              <p>
                ...
                Laskar Pelangi bertambah satu anak perempuan yang bernama Flo, seorang murid pindahan. Keterbatasan yang ada bukan membuat mereka putus asa, tetapi malah membuat mereka terpacu untuk dapat melakukan sesuatu yang lebih baik.
                Laskar Pelangi merupakan buku pertama dari Tetralogi Laskar Pelangi. Buku berikutnya
                adalah Sang Pemimpi, Edensor dan Maryamah Karpov. Buku ini tercatat sebagai buku sastra
                Indonesia terlaris
                sepanjang sejarah.
              </p>
            </div>
