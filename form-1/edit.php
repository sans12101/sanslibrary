...
include "../koneksi.php";
$id=$_GET['BukuID'];
$query = mysqli_query($koneksi,"SELECT * FROM `buku` LEFT JOIN kategoribuku on buku.KategoriID = kategoribuku.KategoriID WHERE BukuID = '$id'");
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
			                    ...
			                    <form role="form" method="post" class="login-form" action="proses_edit.php">

                                    <div class="form-group">
			                    		<label class="sr-only" for="form-username">Judul</label>
                                        <h5>Judul</h5>
			                        	<select name="kategori" id="from-control">
                                        <?php
                                    ...
                                    <div class="form-group">
			                    		<label class="sr-only" for="form-username">IDBuku</label>
                                        <h5>IDBuku</h5>
			                        	<input type="hidden" name="BukuID" placeholder="IDBuku..." class="form-username form-control" id="form-username"
                                        value="<?php echo $data['BukuID'];?>">
