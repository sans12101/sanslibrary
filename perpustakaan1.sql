...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Feb 2024 pada 08.57
...
(1, 'Naruto', 'Mashasi Kyshimoto', 'Shueisha ', '1999-10-21'),
(2, 'Romeo And Juliet', 'William Shakespeare ', 'Wordsworth Classic', '2000-01-14'),
(3, 'a', 'a', 'a', '2024-02-21');
...
CREATE TABLE `peminjaman` (
  ...
  `StastusPeminjaman` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user` (
  ...
  `level` enum('admin','pengguna','petugas') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(14, 'ihsan', '202cb962ac59075b964b07152d234b70', 'ihsan@gmail.com', 'ihsan', 'batujajar', 'pengguna'),
(16, 'san', '123', 'sans@gmail.com', 'san', 's', 'admin');
